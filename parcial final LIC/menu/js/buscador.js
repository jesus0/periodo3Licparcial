...
var pagina_buscador = '/menu/buscador.html'	//ruta y nombre de la pagina de busqueda (con barra por delante)
...
function IniciaBuscador(palabraClave, paginacion, nuevaBusqueda) {
	...
	if ( palabraClave == "" ) {
		alert("Introduzca cadena de busqueda por favor.")
		return
	}
	...
	CreaCabecera('<p>Resultados de la busqueda</p>')
