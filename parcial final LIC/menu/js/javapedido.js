...
function visualizarcarrito() {
   ...
   for (i = 1; i <= numerodeorden; i++) {
    ...
    tablas += "<tr style='font: 9pt; text-align: justify; color=white'><td>" + campos[2] + "</td><td  style='color=navy'>"
        ...
        + "<td><input type=button id=boton value=\"  Eliminar  \" onClick=\"quitardelcarrito("+i+")\">"
      	+ "&nbsp;<input type=button id=boton value=\"  Cat&aacute;logo  \" onClick=\"parent.history.back()\"></td>"
   ...
   document.write("</td><td colspan=2 style='font: 7pt; text-align: center; color=white'>Gracias Por Preferir Nuestros Productos</td>");
}
